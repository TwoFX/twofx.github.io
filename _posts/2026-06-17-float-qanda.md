...
Starting in Lean 4.33, `Float`, and *some* of the functions defined for floats,
...
- In a downstream library, develop a fully-featured general-purpose
  ...
  or by reading the IEEE-754 specification (and maybe the *Handbook of
  Floating-Point Arithmetic*) and writing something from scratch
...
implementation-defined behavior. There is an article called [*The pitfalls of
verifying floating-point operations*](https://arxiv.org/pdf/cs/0701192) which
...
[3](https://github.com/leanprover/lean4/pull/14012)), and now, *as long as code
called via FFI does not mess with the floating-point environment*, we can be
