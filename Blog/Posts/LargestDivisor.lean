...
set_option verso.exampleProject "examples/largest-divisor"
set_option verso.exampleModule "LargestDivisor"

set_option pp.rawOnError true

#doc (Post) "The largest divisor" =>
...
The proof of this claim is a few dozen lines of code. In this post, you can hover
over the code samples above to see the types of the functions and theorems involved,
but you can also click [here](https://live.lean-lang.org/#project=mathlib-stable&url=https%3A%2F%2Fraw.githubusercontent.com%2FTwoFX%2Fhuman-eval-lean%2Frefs%2Fheads%2Fmaster%2FHumanEvalLean%2FHumanEval24.lean)
to be dropped into the Lean web editor with the proof loaded in. You
